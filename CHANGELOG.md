...
- **SelfTrack timeline zoom** — `popups/SelfTrackPopup.qml` click on the strip drills into that hour (×60 wider segments, quarter-hour ticks, `‹ ›` steppers + `24h` reset, taller 34px strip); zoom resets on date change.
