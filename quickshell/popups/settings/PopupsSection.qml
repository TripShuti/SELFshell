  ...
  ColumnLayout {
    ...
    SetCard {
      ...
      SetSlider {
        ...
        onMoved: function(v) { root.cfg.popupBgOpacity = v; root.ac.saveSoon() }
      }
      SetSlider {
        sys: root.sys
        ...
        onMoved: function(v) { root.cfg.popupBgLighten = v; root.ac.saveSoon() }
      }
      SetSlider {
        sys: root.sys
        label: "Corner radius"; from: 0; to: 24; step: 1; suffix: "px"
        value: root.cfg.popupRadius
        onMoved: function(v) { root.cfg.popupRadius = v; root.ac.saveSoon() }
      }
      SetSlider {
        sys: root.sys
        label: "Border width"; from: 0; to: 4; step: 1; suffix: "px"
        value: root.cfg.popupBorderWidth
        onMoved: function(v) { root.cfg.popupBorderWidth = v; root.ac.saveSoon() }
      }
    }
    ...
    SetCard {
      ...
      SetSlider {
        ...
        onMoved: function(v) { root.cfg.toastRadius = v; root.ac.saveSoon(); root._previewToast() }
      }
      SetSlider {
        sys: root.sys
        label: "Toast gradient"; from: 1.0; to: 2.0; step: 0.05; decimals: 2
        value: root.cfg.toastLighten
        onMoved: function(v) { root.cfg.toastLighten = v; root.ac.saveSoon(); root._previewToast() }
      }
      SetSlider {
        sys: root.sys
        label: "Toast opacity"; from: 0.5; to: 1.0; step: 0.05; decimals: 2
        value: root.cfg.toastBgOpacity
        onMoved: function(v) { root.cfg.toastBgOpacity = v; root.ac.saveSoon(); root._previewToast() }
      }
      SetSlider {
        sys: root.sys
        label: "OSD radius"; from: 0; to: 24; step: 1; suffix: "px"
        value: root.cfg.osdRadius
        onMoved: function(v) { root.cfg.osdRadius = v; root.ac.saveSoon(); root._previewOsd() }
      }
      SetSlider {
        sys: root.sys
        label: "OSD gradient"; from: 1.0; to: 2.0; step: 0.05; decimals: 2
        value: root.cfg.osdLighten
        onMoved: function(v) { root.cfg.osdLighten = v; root.ac.saveSoon(); root._previewOsd() }
      }
      SetSlider {
        sys: root.sys
        label: "OSD opacity"; from: 0.5; to: 1.0; step: 0.05; decimals: 2
        value: root.cfg.osdBgOpacity
        onMoved: function(v) { root.cfg.osdBgOpacity = v; root.ac.saveSoon(); root._previewOsd() }
      }
    }
